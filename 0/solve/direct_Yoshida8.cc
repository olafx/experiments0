...
force evaluation:
    direct
integration:
    8th order Yoshida by Yoshida (1990)
*/
...
/******************************************************************************/
    ...
    constexpr double w7 =  1.04242620869991;
    constexpr double w6 =  1.82020630970714;
    constexpr double w5 =  0.157739928123617;
    constexpr double w4 =  2.44002732616735;
    constexpr double w3 = -0.00716989419708120;
    constexpr double w2 = -2.44699182370524;
    constexpr double w1 = -1.61582374150097;
    constexpr double w0 =  1-2*(w1+w2+w3+w4+w5+w6+w7);

    constexpr double c16 = .5*(w7);
    constexpr double c15 = .5*(w6+w7);
    constexpr double c14 = .5*(w5+w6);
    constexpr double c13 = .5*(w4+w5);
    constexpr double c12 = .5*(w3+w4);
    constexpr double c11 = .5*(w2+w3);
    constexpr double c10 = .5*(w1+w2);
    constexpr double c9  = .5*(w0+w1);
    constexpr double c8  = .5*(w0+w1);
    constexpr double c7  = .5*(w1+w2);
    constexpr double c6  = .5*(w2+w3);
    constexpr double c5  = .5*(w3+w4);
    constexpr double c4  = .5*(w4+w5);
    constexpr double c3  = .5*(w5+w6);
    constexpr double c2  = .5*(w6+w7);
    constexpr double c1  = .5*(w7);

    constexpr double d15 = w7;
    constexpr double d14 = w6;
    constexpr double d13 = w5;
    constexpr double d12 = w4;
    constexpr double d11 = w3;
    constexpr double d10 = w2;
    constexpr double d9  = w1;
    constexpr double d8  = w0;
    constexpr double d7  = w1;
    constexpr double d6  = w2;
    constexpr double d5  = w3;
    constexpr double d4  = w4;
    constexpr double d3  = w5;
